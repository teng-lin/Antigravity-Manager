            ...
            <td className="px-4 py-1">
                {account.quota?.is_forbidden ? (
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-1 py-0">
                        {models.map((model) => (
                            <div key={model.name} className="relative h-[22px] flex items-center px-1.5 rounded-md overflow-hidden border border-gray-100/50 dark:border-white/5 bg-gray-50/30 dark:bg-white/5 group/quota">
                                <div
